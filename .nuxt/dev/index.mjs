...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/workspace/lasp/portal/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/workspace/lasp/portal/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/workspace/lasp/portal/node_modules/devalue/index.js';
import destr from 'file://D:/workspace/lasp/portal/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/workspace/lasp/portal/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/workspace/lasp/portal/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/workspace/lasp/portal/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/workspace/lasp/portal/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/workspace/lasp/portal/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/workspace/lasp/portal/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/workspace/lasp/portal/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/workspace/lasp/portal/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/workspace/lasp/portal/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/workspace/lasp/portal/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/workspace/lasp/portal/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/workspace/lasp/portal/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/workspace/lasp/portal/node_modules/vue/index.mjs';
import { hash } from 'file://D:/workspace/lasp/portal/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/workspace/lasp/portal/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/workspace/lasp/portal/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/workspace/lasp/portal/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/workspace/lasp/portal/node_modules/@unhead/shared/dist/index.mjs';
...
const _1NbcToCKHo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/workspace/lasp/portal";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"UTF-8"},{"name":"description","content":"법률구조 플랫폼 페이지입니다."},{"name":"keywords","content":"법률구조 플랫폼에서 법률상담을 받아보세요"}],"link":[],"style":[],"script":[{"src":"//dapi.kakao.com/v2/maps/sdk.js?appkey=6805619df2ce78e0e8f9e6803478d249&autoload=false"},{"src":"//dapi.kakao.com/v2/maps/sdk.js?appkey=6805619df2ce78e0e8f9e6803478d249&autoload=false&libraries=services,clusterer"}],"noscript":[],"charset":"UTF-8","viewport":"width=device-width, initial-scale=1","title":"법률구조 플랫폼","htmlAttrs":{"lang":"ko"}};
...
const _lazy_QXt151 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QXt151, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QXt151, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"D:/workspace/lasp/portal/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\workspace\\lasp\\portal","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\workspace\\lasp\\portal\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\workspace\\lasp\\portal\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\workspace\\lasp\\portal\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\workspace\\lasp\\portal\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://D:/workspace/lasp/portal/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
