...
const selectStartDate = defineModel('selectStartDate');
const selectEndDate = defineModel('selectEndDate');
...
watch(selectedRange, (val) => {
  ...
  selectStartDate.value = `${start.getFullYear()}.${start.getMonth() + 1}.${start.getDate()}`;
  selectEndDate.value = `${end.getFullYear()}.${end.getMonth() + 1}.${end.getDate()}`;
});
</script>
