<!--
 * 화면명 : 전자접수신청_한국가정법률상담소 정보동의
 * 화면ID : LASP_ELE_014_01
 * 파일명 : ElrcptKlacfrAgreInfo
 * 작성자 : 김정남
 * 화면 설명 : 한국가정법률상담소 정보 동의를 확인하는 화면
...
const inptMove = () => {
  ...
  navigateTo('./ElrcptKlacfrM'); //입력페이지로 이동
};
</script>
...
@use 'assets/style/pages/elrcpt/form/ElrcptKlacfrAgreInfo';
</style>
