<!--
 * 화면명 : 전자접수신청_대한상사중재원 정보동의
 * 화면ID : LASP_ELE_020
 * 파일명 : ElrcptKcabAgreInfo
 * 작성자 : 안태정
 * 화면 설명 : 대한상사중재원 정보 동의를 확인하는 화면
...
const casePvsnAgreYn = ref('N'); /* 사례제공동의여부 */
const rghtUdsdAgreYn = ref('N'); /* 권리이해동의여부 */
...
const inptMove = () => {
  ...
  if (casePvsnAgreYn.value === 'N') {
    showAlert({
      icon: 'warning',
      html: `사례제공에 동의해주셔야 합니다.`
    });
    return;
  }
  ...
  if (rghtUdsdAgreYn.value === 'N') {
    showAlert({
      icon: 'warning',
      html: `본인의 권리이해에 동의해주셔야 합니다.`
    });
    return;
  }
  navigateTo('./ElrcptKcabM'); //입력페이지로 이동
};
</script>
    ...
    <section class="section2">
      <div class="container">
        ...
        <div class="receipt-form-info">
          <div class="info-box">
            <div class="info-top">
              ⌜법률구조법 제3조⌟에 근거한 대한가정법률복지상담원은
              대한가정법률복지상담원가 제공하는 법률구조를 위하여 아래와 같은
        ...
        <div class="receipt-agree-box">
          <div class="tit"><span class="num">3.</span>사례제공 동의</div>
          ...
          <div class="guide-box">
            ...
            <a-radio-group v-model:value="casePvsnAgreYn">
              <a-radio class="radio-bx" value="Y">동의합니다.</a-radio>
              <a-radio class="radio-bx" value="N">동의하지 않습니다.</a-radio>
            </a-radio-group>
          </div>
        ...
        <div class="receipt-agree-box">
          <div class="tit-box">
            <div class="tit">
              <span class="num">4.</span>본인은 본 동의서 내용과 개인정보
              수집·처리 및 제3자 제공에 관한 본인의 권리에 대하여 이해하고
              동의합니다.
            </div>
...
@use 'assets/style/pages/elrcpt/form/ElrcptKcabAgreInfo';
</style>
