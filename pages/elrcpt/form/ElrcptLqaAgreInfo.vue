<!--
 * 화면명 : 전자접수신청_대한가정법률복지상담원 정보동의
 * 화면ID : LASP_ELE_015
 * 파일명 : ElrcptLqaAgreInfo
 * 작성자 : 김정남
 * 화면 설명 : 대한가정법률복지상담원 정보 동의를 확인하는 화면
...
const inptMove = () => {
  ...
  navigateTo('./ElrcptLqaM'); //입력페이지로 이동
};
</script>
    ...
    <section class="section2">
      <div class="container">
        ...
        <div class="receipt-form-info">
          <div class="info-box">
            <div class="info-top">
              상담원에서는 심도있는 면접상담을 통해 조정, 화해로 당사자간에 연결
              고리를 이어주는 일에 가장 큰 중점을 두고 있습니다.
            </div>
          </div>
        </div>
...
@use '~/assets/style/pages/elrcpt/form/ElrcptLqaAgreInfo';
</style>
