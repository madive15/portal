<!--
* 화면명 : 한국가정법률상담소 사이버상담 폼
* 화면ID : LASP_CON_031
* 파일명 : CybKlacfrM
* 작성자 : 김정남
* 화면설명 : 한국가정법률상담소 사이버상담 페이지
...
const selectDscsnInfo = async () => {
  ...
  const response = await axios.post('/api/dscsn/selectCybKlacfrInfo', formData);
...
/**
 * name : insertBtn
 * desc : 한국가정법률상담소 사이버상담 신청 데이터 저장
 */
...
/**
 * name : updateBtn
 * desc : 한국가정법률상담소 사이버상담 신청 데이터 수정
 */
...
@use 'assets/style/pages/dscsn/cyber/klacfr/CyberKlacfrM';
</style>
