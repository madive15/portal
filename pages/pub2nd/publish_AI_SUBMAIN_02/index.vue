...
<template>
  <div class="sub-content-box" id="ai-qustion">
    <section class="section1">
      <div class="container">
        <span class="ai-tag">생성형 법률정보 검색</span
        ><!-- Description : 마크업 추가 -->
        <CommonTitle tag="h2" size="1">
          <picture>
            <source
              media="(max-width: 1199px)"
              srcset="/image/sub/ai/ai_main_title_mo.png"
            />
            <source
              media="(min-width: 1200px)"
              srcset="/image/sub/ai/ai_main_title_02_pc.png"
            />
            <!-- Description : 이미지 경로 수정 -->
            <img
              src="/image/sub/ai/ai_main_title_02_pc.png"
      ...
      <div class="container">
        <div class="slide-box">
          <div class="content-header">
            <div class="title-box">
              <CommonTitle tag="h3" size="1">대화목록</CommonTitle>
            </div>
            ...
            >
              <SwiperSlide class="slide-item1">
                <button
                  ...
                  class="btn-ai-slide"
                >
                  <span title="양육비" class="truncate-span">
                    <span>양육비</span>
                  </span>
                </button>
              </SwiperSlide>
              <SwiperSlide class="slide-item2">
                ...
                >
                  ...
                  <span
                    title="<span></span>무료 법률상담이 가능한 기관을 알려줘"
                    class="truncate-span"
                  >
                    <span>무료 법률상담이 가능한 기관을 알려줘</span>
                  </span>
                </button>
              </SwiperSlide>
