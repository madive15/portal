...
import OneStop from './one-stop/index.vue';
import LawCase from './law-case/index.vue';
import StickyChatbot from './sticky-chatbot/index.vue';
...
<template>
  ...
  <div id="common-content" class="main-wrap" v-if="!isMobile">
    ...
    >
      ...
      >
        <h3 class="sr-only">One-Stop 법률구조/사례,서식</h3>
        <div class="container">
          <div class="row">
      ...
      <section
        ...
        id="new-more"
        class="new-more-section scroll-section end-section no-related"
      >
  ...
  <div id="common-content" class="wrap main-wrap" v-else>
    ...
    <div class="main-snap-y">
      ...
      <section
        id="new-more"
        class="new-more-section scroll-section service-section no-related"
      >
        <section class="main-information-section">
          <div class="container">
            <h4>서비스 유형별 참여기관</h4>
