        ...
        <div class="form-area">
          ...
          <div class="form-box">
            <div class="form-item">
              ...
              <div class="inner resident-number">
                <a-input class="text-bx" title="전화번호 앞자리 입력" />
                <span aria-hidden="true">-</span>
                <a-input class="text-bx" title="전화번호 가운데 입력" />
                <span aria-hidden="true">-</span>
                <a-input class="text-bx" title="전화번호 뒷자리 입력" />
              </div>
            </div>
          </div>
          <div class="form-box">
            <div class="form-item">
              ...
              <div class="inner resident-number">
                <a-input class="text-bx" title="휴대전화번호 앞자리 입력" />
                <span aria-hidden="true">-</span>
                <a-input class="text-bx" title="휴대전화번호 가운데 입력" />
                <span aria-hidden="true">-</span>
                <a-input class="text-bx" title="휴대전화번호 뒷자리 입력" />
              </div>
            </div>
          </div>
          <div class="form-box">
            <div class="form-item">
              ...
              <div class="inner resident-number">
                <a-input class="text-bx" title="이메일 아이디 입력" />
                <span aria-hidden="true">@</span>
                <a-input class="text-bx" title="이메일 도메인 입력" readonly />
                <a-select
                  class="common-select"
                  placeholder="선택"
                  title="이메일 도메인 선택"
