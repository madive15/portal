...
const baTypeCodes = await useCommonCodeStore().searchCommonCodeList('NTC_TYPE');
            ...
            <div class="content-body">
              ...
              <div class="nuri-type-box">
                <div class="img-box">
                  <!-- 유형별로 다른 이미지 표시 -->
                  <img
                    v-if="boardArticle.baNuri === 'TYPE1'"
                    src="~/assets/image/sub/etc/copyright01.png"
                    alt="공공누리 공공저작물 자유이용허락 출처표시"
                  />
                  <img
                    v-else-if="boardArticle.baNuri === 'TYPE2'"
                    src="~/assets/image/sub/etc/copyright02.png"
                    alt="공공누리 공공저작물 자유이용허락 출처표시 + 상업적 이용금지"
                  />
                  <img
                    v-else-if="boardArticle.baNuri === 'TYPE3'"
                    src="~/assets/image/sub/etc/copyright03.png"
                    alt="공공누리 공공저작물 자유이용허락 출처표시 + 변경금지"
                  />
                  <img
                    v-else-if="boardArticle.baNuri === 'TYPE4'"
                    src="~/assets/image/sub/etc/copyright04.png"
                    alt="공공누리 공공저작물 자유이용허락 출처표시 + 상업적 이용금지 + 변경금지"
                  />
                </div>

                <div class="img-text-box">
                  <!-- 유형별 안내 문구도 분기 처리 -->
                  <p v-if="boardArticle.baNuri === 'TYPE1'">
                    법률구조플랫폼이 보유한
                  ...
                  <p v-else-if="boardArticle.baNuri === 'TYPE2'">
                    법률구조플랫폼이 보유한
                    <b class="highlight">[문화PD] 이미지명</b><br />
                    본 저작물은 "공공누리"
                  ...
                  <p v-else-if="boardArticle.baNuri === 'TYPE3'">
                    법률구조플랫폼이 보유한
                    <b class="highlight">[문화PD] 이미지명</b><br />
                    본 저작물은 "공공누리"
                    <span class="text-re-span"
                  ...
                  <p v-else-if="boardArticle.baNuri === 'TYPE4'">
                    법률구조플랫폼이 보유한
                    <b class="highlight">[문화PD] 이미지명</b><br />
                    본 저작물은 "공공누리"
                    <span class="text-re-span"
